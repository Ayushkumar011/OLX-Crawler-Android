...
import { type Listing, type WatchlistItem, useAddToWatchlist } from "@workspace/api-client-react";
import { X, ExternalLink, MapPin, Calendar, User, Tag, BookmarkPlus } from "lucide-react";
...
interface ListingDetailModalProps {
  listing: Listing | WatchlistItem | null;
  onClose: () => void;
}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-black/20 p-4 rounded-xl border border-white/5">
                    ...
                    <div className="font-medium text-white text-sm">
                      {('listingDate' in listing ? listing.listingDate : null) || format(new Date(listing.createdAt), 'MMM d, yyyy HH:mm')}
                    </div>
                  </div>
          ...
          <div className="p-6 border-t border-white/10 bg-black/20 flex gap-4 justify-end">
            {!('status' in listing) && (
              <NeonButton 
                ...
                className="flex items-center bg-white/5 border-white/20 hover:bg-white/10 text-white"
              >
                Add to Watchlist <BookmarkPlus className="w-4 h-4 ml-2" />
              </NeonButton>
            )}
            <NeonButton 
